  ...
  static ThemeData get lightTheme {
    return ThemeData(
      ...
      textTheme: GoogleFonts.interTextTheme().copyWith(
        ...
        displayMedium: GoogleFonts.manrope(fontSize: 28, fontWeight: FontWeight.bold, color: AppColors.textPrimary),
        displaySmall: GoogleFonts.manrope(fontSize: 24, fontWeight: FontWeight.bold, color: AppColors.textPrimary),
        headlineLarge: GoogleFonts.manrope(fontSize: 22, fontWeight: FontWeight.w700, color: AppColors.textPrimary),
        headlineMedium: GoogleFonts.manrope(fontSize: 20, fontWeight: FontWeight.w600, color: AppColors.textPrimary),
        headlineSmall: GoogleFonts.manrope(fontSize: 18, fontWeight: FontWeight.w600, color: AppColors.textPrimary),
        titleLarge: GoogleFonts.manrope(fontSize: 16, fontWeight: FontWeight.w600, color: AppColors.textPrimary),
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        hintStyle: GoogleFonts.inter(color: AppColors.textGray400, fontSize: 14),
      ...
      chipTheme: ChipThemeData(
        ...
        labelStyle: GoogleFonts.inter(color: AppColors.primaryPurple, fontSize: 12, fontWeight: FontWeight.w500),
      ...
      dialogTheme: DialogThemeData(
        ...
        titleTextStyle: GoogleFonts.manrope(fontSize: 18, fontWeight: FontWeight.w600, color: AppColors.textPrimary),
      ),
